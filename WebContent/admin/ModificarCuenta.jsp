	...
	<div class="container">
		<form id="accountForm" action="servletHTM" method="post">
			...
			<fieldset>
				...
				<p>
					<label>CBU:</label> <select name="cbu" id="cbuSelect">
				...
				<p>
					<label>Cliente:</label> <select name="cliente" id="clienteSelect">
				...
				<p>
					<label>Saldo de Cuenta: </label> <input type="text" name="saldo"
						value="$ 12,000" id="saldoField" onblur="formatSaldo()" />
				</p>
...
cuenta, un número de cuenta, CBU y un saldo -->
				<p>
					...
					<button type="button" id="btnModificarCuenta"
						class="btn btn-delete">Modificar Cuenta</button>
				</p>
			</fieldset>
		</form>
	</div>
